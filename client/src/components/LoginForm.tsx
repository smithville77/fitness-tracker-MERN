    ...
    <form className="w-full max-w-sm" onSubmit={handleSubmit}>
      <div className="md:flex md:items-center mb-6">
        ...
        <div className="md:w-2/3">
          ...
          <input
            className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-black leading-tight focus:outline-none focus:bg-white focus:border-lime-500" id="inline-full-name"
            type="text"
            value={username}
      ...
      <div className="md:flex md:items-center">
        ...
        <div className="md:w-2/3">
          <button className="shadow bg-lime-500 hover:bg-lime-400 focus:shadow-outline focus:outline-none text-black font-bold py-2 px-4 rounded shadow-xl" type="submit">
            Login
          </button>
        </div>
      </div>
